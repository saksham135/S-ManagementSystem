...
class Report1Class:
    def __init__(self, pwindow) -> None:
        ...
        self.bimg1 = Image.open("projectimages//r1.jpg")
        ...
        self.head1 = Label(self.mw, text="Student Reports", font=('Arial', 31, 'bold'), bg='#d7948c', relief='groove',
                           width=50)
